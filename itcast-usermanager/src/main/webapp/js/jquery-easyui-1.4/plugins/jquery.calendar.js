...
(function($) {
	...
	function _e(_30) {
		...
		var _32 = now.getFullYear() + "," + (now.getMonth() + 1) + ","
				+ now.getDate();
		var _33 = _31.current ? (_31.current.getFullYear() + ","
				+ (_31.current.getMonth() + 1) + "," + _31.current.getDate())
				: "";
		...
		$(_30).find(".calendar-title span").html(
				_31.months[_31.month - 1] + " " + _31.year);
			...
			if (_41) {
				...
				_41 = $.data(this, "calendar", {
					options : $.extend({}, $.fn.calendar.defaults,
							$.fn.calendar.parseOptions(this), _3f)
				});
				_6(this);
			}
